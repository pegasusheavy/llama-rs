...
fn main() {
    ...
    println!(
        "  Logit stats: min={:.4}, max={:.4}, mean={:.4}, sum={:.4}",
        min_logit, max_logit, mean_logit, sum_logit
    );
    println!(
        "  Sample [0:5]: {:?}",
        &logits_v1[..5]
    ...
    println!(
        "  Top 5: [(17, \"17.99\"), (16, \"17.54\"), (18, \"17.16\"), (20, \"15.98\"), (9909, \"15.86\")]"
    );
}
